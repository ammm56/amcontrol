...
namespace GTN
{
    ...
    public class mc_la
    {
        ...
        unsafe public delegate void* TCallbackFunction();

        [DllImport("gts.dll")]
        public static extern short GTN_SetCallbackFunctionParameter(short core, TCallbackFunction callbackFunction);
    }
}