...
说明：本文档中涉及 `.NET Framework 4.7.2`、VS2019 兼容和旧式项目结构的内容，默认仅描述当前实现事实，不构成未来整体迁移到 `.NET 10` 的限制。

---

## 内容范围

- **环境搭建**：开发环境要求（.NET Framework 4.7.2、Visual Studio 版本、SDK 兼容边界）、首次克隆后的配置步骤。
