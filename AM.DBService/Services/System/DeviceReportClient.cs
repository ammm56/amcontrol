...
namespace AM.DBService.Services.System
{
    ...
    public class DeviceReportClient : ServiceBase
    {
        ...
        /// <summary>
        /// 设备请求加密服务。
        /// 负责把 report 明文 DTO 封装成 AES-GCM 信封。
        /// </summary>
        ...
        public async Task<Result> ReportAsync(DeviceReportRequest request)
        {
            try
            {
                ...
                Result<DeviceEncryptedRequestPackage> encryptedResult = _deviceRequestCryptoService.BuildReportPackage(setting.DeviceId, request);
